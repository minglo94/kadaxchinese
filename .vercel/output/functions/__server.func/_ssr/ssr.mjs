...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-AqWO6ogB.mjs");
...
var manifest = {
	"0c5a06178f3eb2ddaac554a30d244d37cce60e9b6b9ce689aaa01bfd18804e87": {
		functionName: "generateQuiz_createServerFn_handler",
		importer: () => import("./ai-D7rwSeL_.mjs")
	},
	"75b117e63abc8b4576ce0c9a7e13a47b7e82c2a7d4372a679cf61f8f74b85d2d": {
		functionName: "explainQuiz_createServerFn_handler",
		importer: () => import("./ai-D7rwSeL_.mjs")
	},
	"9992ca6e632ed08aa35eb4a5c98bb5a8aea582a8fd1b2edb64a5ae9dc3049c67": {
		functionName: "gradeDictation_createServerFn_handler",
		importer: () => import("./ai-D7rwSeL_.mjs")
	},
	"a0f232b5ca0187bc9fe40a301ee2940b0a5db3a672463d1e57d3938a935a6d51": {
		functionName: "aiStatus_createServerFn_handler",
		importer: () => import("./ai-D7rwSeL_.mjs")
	},
	"aa1f57deb989cb2243ad631467fdd8027270dc7b122a7790d873db1ae77a2d4c": {
		functionName: "tutorChat_createServerFn_handler",
		importer: () => import("./ai-D7rwSeL_.mjs")
	},
	"f313621e15afa40d27d6fa1834e943da25b305a1ca5a179312e1d50fd18d763a": {
		functionName: "pingAi_createServerFn_handler",
		importer: () => import("./ai-D7rwSeL_.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-D1ip8uWF.mjs").then((n) => n.t),
